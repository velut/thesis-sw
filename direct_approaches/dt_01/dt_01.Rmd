...
CF_TASK_FILE_PATH <- file.path(INPUT_PATH, "DT_01__f1189068.csv")
...
data_base <- 
  ...
  select(
    ...
    fragment_relevance = 
     how_relevant_do_you_think_the_process_fragment_is_with_respect_to_the_query,
    relevant_node_ids = 
     select_all_the_activities_from_the_process_fragment_which_you_think_are_relevant_to_the_query,
    worker_explanation = 
