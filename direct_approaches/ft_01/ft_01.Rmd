---
title: "Former Task 01 (Label Only)"
...
CF_TASK_FILE_PATH <- file.path(INPUT_PATH, "FT_01__f885474.csv")
...
data_base <- 
  ...
  select(
    ...
    fragment_relevance =
      please_provide_a_rating_of_how_similar_these_two_activities_are,
    # Workers could vote "yes"/"no" to say if the activities presented
    # in a pair are similar or not
    is_pair = 
      are_the_two_activities_given_above_similar,
